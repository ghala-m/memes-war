...
const dict = {
  en: {
    tagline: "Pick the meme. Win the crowd.",
    subtitle:
      "A real-time party game: everyone answers the prompt with one meme, then votes for the best.",
    play: "Play",
    ...
    of: "of",
    getReady: "Get ready…",
    pickEmoji: "Pick your meme",
    browseAll: "Browse all memes",
    ...
    rule1: "+10 if your meme wins the round",
    rule2: "+5 for every vote your meme gets",
    rule3: "+3 if you vote for the winning meme",
    questions: "Questions",
  ...
  ar: {
    tagline: "اختر الميم. اكسب الجمهور.",
    subtitle: "لعبة جماعية مباشرة: كل لاعب يجاوب على السؤال بصورة ميم، ثم يصوّت على الأفضل.",
    play: "العب",
    ...
    of: "من",
    getReady: "استعدوا…",
    pickEmoji: "اختر الميم",
    browseAll: "تصفح كل الميمز",
    ...
    rule1: "+١٠ إذا فاز الميم الخاص بك",
    rule2: "+٥ لكل صوت يحصل عليه اختيارك",
    rule3: "+٣ إذا صوّت للميم الفائز",
    questions: "الأسئلة",
